...
> **授权说明**：本作品采用 **CC BY-NC 4.0（署名-非商业性使用）** 许可——学校与教师可自由使用、改编，须保留署名「吕彩玲（铝老师）」，**不得用于商业用途**；商业合作请联系作者。v1.0 版本曾以 MIT 许可发布（见 `v1.0-mit` 标签），自 v1.1 起改用 CC BY-NC 4.0。
...
完整版模板第八部分生成「课堂教学思维结构」——原型来自**作者 2011 年参与的一项上海市级课题研究**，此后在作者担任教研员与校长期间的课堂实践中持续迭代：
...
- 学校、教师与教研机构可自由使用、复制、改编，须保留署名「吕彩玲（铝老师）」；
