...
**四个附录对应四个备课动作**：学习任务设计表（把任务列清楚）· 五类问题设计（识记/理解/发散/评价/管理）· 本节课 AI 技术应用建议（涉及资源优先推荐国家智慧教育平台，注明资源名称与检索关键词；表下备注：教学设计可直接发给智能体协助实现任一条建议）· 电子白板/教学平台使用建议；作业按"基础—挑战—实践"三层组织，照顾不同学习起点。附录的另一层价值：让教师的日常备课与学校数智化转型自然连接——不是先组织庞大的通用培训再等迁移，而是把建议落到具体任务、课堂环节和工具选择上，**边用边学，降低培训的时间成本和学习成本**。
