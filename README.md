...
> **授权说明**：本作品采用 **CC BY-NC 4.0（署名-非商业性使用）** 许可——学校与教师可自由使用、改编，须保留署名「铝老师（吕彩玲）」，**不得用于商业用途**；商业合作请联系作者。v1.0 版本曾以 MIT 许可发布（见 `v1.0-mit` 标签），自 v1.1 起改用 CC BY-NC 4.0。
...
- **名师引路（可选）**：按学段×学科匹配公开教学名家，附课例视频搜索入口。名师引路不是模仿，而是**榜样的引领**——每位教师都值得培养：哪怕没有荣誉等身，也可以在名家课例与风格参照中发掘自身优势，逐步形成自己的教学风格，成为充满自信、热爱职业、卓越而平凡的老师；
...
- **REAL 结构化提示词模型**（铝老师 2025 年 12 月研发）：角色、情境与证据、行动、限制——给 AI 员工写的一份"工作交接单"；
- **UBD 逆向设计**：先想清楚学生最终要学会什么、用什么证据判断学习是否发生，再安排课堂活动、评价和作业；
- **课堂追求内置**：不只追求"内容讲完"，还关注学生在学习过程中有没有**安全感、愉悦感和意义感**——这是内置默认理念，**即便学校没有明确的教学主张，也能据此生成高质量的教学设计**；若学校另有主张，则按学校主张对齐。
...
| 课堂教学思维结构 | 不含 | **含**（见下） |
| 教学反思 | 不含 | **含**（成长型思维双表） |
| 适用 | 赶时间、快速成稿 | 磨课、研究课、深度备课——让每一次备课都成为提升教学设计力的刻意练习 |

学校已有自己的教学设计模板？把章节结构贴进「校本教学设计模板」栏，工具按校本要求生成。
...
能力提升版模板第八部分生成「课堂教学思维结构」——原型来自**作者 2011 年参与的一项上海市级课题研究**，此后在作者担任教研员与校长期间的课堂实践中持续迭代：
...
![课堂教学思维结构样例](docs/课堂教学思维结构样例_酸的性质.svg)
...
**铝老师（吕彩玲）**——30 年基础教育经历，从教师、区域教研员到校长，从一堂课走到一所学校。REAL 结构化提示词模型提出者。
...
- 学校、教师与教研机构可自由使用、复制、改编，须保留署名「铝老师（吕彩玲）」；
- **不得用于商业用途**（包括但不限于付费产品、付费课程、商业培训中的直接使用）；商业合作请联系作者；
- 授权变更说明：v1.0 曾以 MIT 许可发布（该版本快照见 `v1.0-mit` 标签，其已获授权不可撤销）；自 v1.1 起，本仓库全部内容改用 CC BY-NC 4.0；
- 本仓库内容对应的 REAL 结构化提示词模型与备课提示词模板已申请发明专利（实质审查阶段），专利权利不受本许可证影响。
